...
| `js/main.js` | App entry — wire controls and start |
...
8. **Local check** — `python3 -m http.server 8080` from the repo root and open `http://localhost:8080` (modules require HTTP)
